object PublishConstants {
    const val PUBLICATION_NAME = "emerald"
    const val ARTIFACT_NAME = "Emerald"
    const val ARTIFACT_GROUP = "co.condorlabs.emerald"
    const val VERSION = "1.0.0"
    const val POM_URL = "https://github.com/cebroker/android-emerald-2.0"
